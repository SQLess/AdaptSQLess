// $ANTLR 3.5.3 org/antlr/v4/codegen/SourceGenTriggers.g 2023-12-20 16:01:29
...
public class SourceGenTriggers extends TreeParser {
	...
	// $ANTLR start "alt"
	// org/antlr/v4/codegen/SourceGenTriggers.g:89:1: alt[boolean outerMost] returns [CodeBlockForAlt altCodeBlock, List<SrcOp> ops] : ( ^( ALT ( elementOptions )? ( element )+ ) | ^( ALT ( elementOptions )? EPSILON ) );
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:146:1: blockSet[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ^( SET ( atom[label,invert] )+ ) ;
	...
	// $ANTLR start "atom"
	// org/antlr/v4/codegen/SourceGenTriggers.g:160:1: atom[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ( ^( NOT a= atom[$label, true] ) | range[label] | ^( DOT ID terminal[$label] ) | ^( DOT ID ruleref[$label] ) | ^( WILDCARD . ) | WILDCARD | terminal[label] | ruleref[label] | blockSet[$label, invert] );
	...
	static final String DFA7_minS =
		"\1\105\1\2\1\4\1\2\2\uffff\1\12\1\3\1\2\1\4\1\34\1\4\10\3";
	...
	public static final BitSet FOLLOW_alternative_in_block109 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000020L});
	...
	public static final BitSet FOLLOW_elementOptions_in_alt193 = new BitSet(new long[]{0x4942408000100410L,0x00000000000C60C0L});
	public static final BitSet FOLLOW_element_in_alt198 = new BitSet(new long[]{0x4942408000100418L,0x00000000000C60C0L});
	public static final BitSet FOLLOW_ALT_in_alt212 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_elementOptions_in_alt214 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000400L});
	...
	public static final BitSet FOLLOW_ID_in_labeledElement349 = new BitSet(new long[]{0x4842008000100000L,0x00000000000C0000L});
	...
	public static final BitSet FOLLOW_ID_in_labeledElement366 = new BitSet(new long[]{0x4842008000100000L,0x00000000000C0000L});
	...
	public static final BitSet FOLLOW_atom_in_blockSet508 = new BitSet(new long[]{0x4842008000100008L,0x00000000000C0000L});
	...
	public static final BitSet FOLLOW_ID_in_atom581 = new BitSet(new long[]{0x0040000000000000L});
	...
	public static final BitSet FOLLOW_ARG_ACTION_in_ruleref687 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000200L});
	...
	public static final BitSet FOLLOW_ARG_ACTION_in_terminal782 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0x00000000000FFFFFL});
